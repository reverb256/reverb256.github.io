    ...
    <div className="about-page">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-7xl mx-auto text-center">
          <h1 className="font-black mb-8 bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent animate-fade-in-up" 
              style={{ fontSize: 'clamp(4rem, 12vw, 10rem)', lineHeight: '0.9', letterSpacing: '-0.02em' }}>
            Reverb256
          </h1>
          
          <p className="text-gray-300 mb-12 mx-auto animate-fade-in-up delay-200" 
             style={{ fontSize: 'clamp(1.25rem, 4vw, 2.5rem)', lineHeight: '1.3', maxWidth: '65ch' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16 max-w-6xl mx-auto">
            <div className="card-container lg:col-span-2">
              <p className="leading-relaxed mb-8" style={{ color: 'var(--neutral-300)', fontSize: 'clamp(1.0625rem, 2.8vw, 1.25rem)', lineHeight: '1.6' }}>
            ...
            <div className="card-container flex flex-col justify-center space-y-4">
              ...
              <a href="https://github.com/reverb256" target="_blank" rel="noopener noreferrer" 
      ...
      <section className="px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-bold mb-16 text-center animate-fade-in-up" 
          ...
          <div className="flex flex-col xl:flex-row gap-12 items-start justify-center">
            ...
            <div className="card-container flex-shrink-0" style={{ maxWidth: '600px' }}>
              <h3 className="font-semibold mb-8 text-center" 
      ...
      <section className="px-6 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <article className="card-container group relative" style={{ maxWidth: '350px', minWidth: '300px' }}>
              <header className="mb-6">
                <h3 className="font-semibold mb-3 flex items-center gap-3" 
                    style={{ fontSize: 'clamp(1.375rem, 3vw, 1.75rem)', color: 'var(--brand-primary)' }}>
                  <span style={{ fontSize: '1.75rem' }}>🔥</span>
                  COREFLAME
                </h3>
                <span className="status-badge status-badge--production">Active Platform</span>
              </header>
              
              <p className="mb-8 leading-relaxed" style={{ color: 'var(--neutral-300)', fontSize: '1rem' }}>
                Consciousness research platform combining ancient wisdom with quantum technology for revolutionary AI development
              </p>
              ...
              <Link 
                ...
                aria-label="Explore COREFLAME consciousness platform"
              >
                Explore Platform
            ...
            <article className="card-container" style={{ maxWidth: '350px', minWidth: '300px' }}>
              <header className="mb-6">
                <h3 className="font-semibold mb-3 flex items-center gap-3" 
                    style={{ fontSize: 'clamp(1.375rem, 3vw, 1.75rem)', color: 'var(--brand-accent)' }}>
                  <span style={{ fontSize: '1.75rem' }}>⚡</span>
                  Solana Trading Bot
                </h3>
                <span className="status-badge status-badge--development">In Development</span>
              </header>
