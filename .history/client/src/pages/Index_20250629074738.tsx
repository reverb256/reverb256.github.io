          ...
          <div className="flex flex-wrap justify-center gap-8">
            <article className="card-container group relative project-tile" style={{ maxWidth: "350px", minWidth: "300px" }}>
              <header className="mb-6">
                <h3 className="font-semibold mb-3 flex items-center gap-3" style={{ fontSize: "clamp(1.375rem, 3vw, 1.75rem)", color: "var(--brand-primary)" }}>
            ...
            <article className="card-container project-tile" style={{ maxWidth: "350px", minWidth: "300px" }}>
              <header className="mb-6">
                <h3 className="font-semibold mb-3 flex items-center gap-3" style={{ fontSize: "clamp(1.375rem, 3vw, 1.75rem)", color: "var(--brand-accent)" }}>
                  <span style={{ fontSize: "1.75rem" }}>⚡</span>
                  Solana Trading Bot
                </h3>
            ...
            <article className="card-container project-tile" style={{ maxWidth: "350px", minWidth: "300px" }}>
              <header className="mb-6">
                <h3 className="font-semibold mb-3 flex items-center gap-3" style={{ fontSize: "clamp(1.375rem, 3vw, 1.75rem)", color: "var(--brand-secondary)" }}>
                  <span style={{ fontSize: "1.75rem" }}>🌐</span>
                  Astralvibe Platform
                </h3>
